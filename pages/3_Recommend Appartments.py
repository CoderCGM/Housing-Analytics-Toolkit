...
location_df = pd.read_pickle(open('datasets/location_distance_1.pkl','rb'))
cosine_sim1 = pd.read_pickle(open('datasets/cosine_sim_1.pkl','rb'))
cosine_sim2 = pd.read_pickle(open('datasets/cosine_sim_2.pkl','rb'))
cosine_sim3 = pd.read_pickle(open('datasets/cosine_sim_3.pkl','rb'))
